...
const Footer: React.FC<FooterProps> = ({ chatBoxSettings, setChatBoxSettings }) => {
  ...
  return (
    <>
      <div className="container flex flex-col sm:flex-row min-h-[60px] sm:min-h-[72px] mt-2 items-center justify-center sm:justify-between border-t border-gray-200 px-4 pb-3 pt-4 sm:py-5 lg:px-0 bg-transparent backdrop-blur-sm gap-3 sm:gap-0 invisible">
        ...
        <div className="flex items-center gap-4 order-1 sm:order-2 mb-2 sm:mb-0">
          <Link href={"https://gptr.dev"} target="_blank" className="p-1">
              <svg 
                ...
                className="w-6 h-6 sm:w-7 sm:h-7 text-white hover:text-primary-500 transition-colors duration-300"
              >
